...
import { Item, Supplier } from '@/app/lib/definitions';
...
export default function EditItemForm({ item, suppliers }: { item: Item; suppliers: Supplier[] }) {
      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <select
            ...
            name="supplier_type"
            className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
            defaultValue={item.supplier_type}
